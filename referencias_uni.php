...
if (isset($_POST['btn'])) {//Filtra los datos
  filtrarReferenciasUnidad($db_conx, $log_id, $_POST['op'], $_POST['btn'], $_POST['rxp'],
          $_POST['pa'], $_POST['est'], $_POST['nro'], $_POST['fd'], $_POST['fh']);
  exit();
}
?>
<!DOCTYPE html>
        ...
        <div class="col_w900">
          ...
          <div id="table_content" class="tablestyle">            
            <table id="table_data">
              ...
              <?php
              SelectReferenciasUnidad($db_conx, $log_id);
              ?>
          ...
          <table class="tr-data">
            <tr style="height: 120px;">
              ...
              <td>
                <a href="javascript:filtrarDatos('referencias_uni', 'ant');">Anterior</a>
                <input disabled="Disabled" style="margin-left: 10px; margin-right: 10px; text-align: center; width: 50px;" type="text" id="pa" value="1"/>
                <a href="javascript:filtrarDatos('referencias_uni', 'sig');">Siguiente</a>
              </td>
            </tr>
          </table>
        </div>
