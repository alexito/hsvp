          ...
          <table class="tr-data">
            <tr>
              ...
              <td>
                ...
                <a id="print-url" class="a-button" href="http://localhost/HSVP/reports/report-page.php?page=unidades&btn=car&rxp=5&pa=1&op=op1&ord=ASC&est=op0&tex=" target="_blank">Ver Reporte</a>
              </td>              
            </tr>
          </table>
